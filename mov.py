...
conf = SparkConf().setAppName("My first standalone udf")
sc = SparkContext(conf=conf)

userRDD = sc.textFile("file:/home/hduser/movie.txt")
...
print "under age movie users",Under_age
print "over age movie users",Over_age
